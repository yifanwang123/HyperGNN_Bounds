...
def parse():
    ...
    p.add_argument('--num_samples', type=int, default=1, help='number of samples')
    p.add_argument('--num_nodes', type=int, default=1, help='number of nodes')
    p.add_argument('--hid_dim', type=int, default=64, help='the dimension of embeddings at the hidden layer')
    ...
    p.add_argument('--run', type=int, default=5, help='number of runs')
    ...
    p.add_argument('--num_exps', type=int, default=1, help='number of repeated experiments')
